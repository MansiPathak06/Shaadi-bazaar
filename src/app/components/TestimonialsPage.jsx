...
const TestimonialsPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-rose-100 via-rose-50 to-amber-50 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mt-16 text-center bg-white rounded-2xl p-12 shadow-xl">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            We would love to hear from you! Share your story and help others make informed decisions.
          </p>
          <Link
            href="/write-review"
            className="inline-block bg-gradient-to-r from-rose-500 to-rose-600 text-white px-10 py-4 rounded-lg font-bold hover:from-rose-600 hover:to-rose-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
          >
            WRITE A REVIEW
          </Link>
        </div>
