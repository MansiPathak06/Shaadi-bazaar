...
const OutfitsCollection = () => {
  ...
  return (
    <div className="w-full px-4 sm:px-6 lg:px-8 pb-0 mb-0">
      <div className="max-w-7xl mx-auto pt-16 pb-0 mb-0">
        ...
        <section className="mb-16">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-sm md:text-base">{mensCollection.description}</p>
          </div>
      ...
      <ArrowRight size={18} />
        ...
        <section className="pb-0 mb-0">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-sm md:text-base">{womensCollection.description}</p>
          </div>
