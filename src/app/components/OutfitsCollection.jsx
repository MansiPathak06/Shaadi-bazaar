      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-12">
          <div className="text-center mb-6">
            <h2 className="text-3xl md:text-4xl font-serif text-gray-900 mb-1 capitalize">
        ...
        <section className="pb-16 mb-0">
          <div className="text-center mb-6">
            <h2 className="text-3xl md:text-4xl font-serif text-gray-900 mb-1 capitalize">
              Women's <span className="text-rose-500">Collection</span>
            </h2>
            <p className="text-gray-600 text-sm">{womensCollection.description}</p>
          </div>
