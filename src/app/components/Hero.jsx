...
const HeroPage = () => {
  ...
  return (
    <div className="w-full overflow-hidden bg-gradient-to-b from-rose-50 to-white">
      ...
      <section className="relative w-full h-160 lg:h-160 ">
        {/* Slider Container */}
        <div className="relative w-full h-full overflow-hidden">
          ...
          <button
            onClick={prevSlide}
            className=" hidden lg:block absolute left-4 md:left-8 top-7/8 lg:top-1/2 -translate-y-1/2 z-30 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white p-3 md:p-4 rounded-full transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-white/50"
          ...
          <button
            onClick={nextSlide}
            className="hidden lg:block absolute right-4 md:right-8 top-7/8 lg:top-1/2 -translate-y-1/2 z-30 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white p-3 md:p-4 rounded-full transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-4 focus:ring-white/50"
