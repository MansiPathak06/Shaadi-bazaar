          ...
          {blogPosts.map((post, index) => (
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <button
                  className="mt-auto cursor-pointer px-6 py-3 bg-gradient-to-r from-rose-400 via-pink-400 to-rose-500 text-white font-bold rounded-xl hover:from-rose-500 hover:via-pink-500 hover:to-rose-600 transition-all duration-300 outline-none focus:ring-4 focus:ring-rose-300 shadow-md hover:shadow-xl transform hover:scale-105"
                  type="button"
                >
                  READ MORE
                </button>
