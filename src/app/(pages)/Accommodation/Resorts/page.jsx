                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
                            <img src="/api/placeholder/300/200" alt="Nature Trails" className="w-full h-40 object-cover rounded-lg mb-4" />
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
                            <img src="/api/placeholder/300/200" alt="Water Sports" className="w-full h-40 object-cover rounded-lg mb-4" />
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
                            <img src="/api/placeholder/300/200" alt="Cultural Evening" className="w-full h-40 object-cover rounded-lg mb-4" />
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition duration-300">
                            <img src="/api/placeholder/300/200" alt="Stargazing" className="w-full h-40 object-cover rounded-lg mb-4" />
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <img src="/api/placeholder/300/250" alt="Wedding Setup" className="rounded-2xl shadow-lg" />
                            <img src="/api/placeholder/300/250" alt="Corporate Event" className="rounded-2xl shadow-lg mt-8" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="space-y-4">
                            <img src="/api/placeholder/300/400" alt="Gallery 1" className="w-full rounded-2xl shadow-lg" />
                            <img src="/api/placeholder/300/300" alt="Gallery 2" className="w-full rounded-2xl shadow-lg" />
                        </div>
                        <div className="space-y-4">
                            <img src="/api/placeholder/300/300" alt="Gallery 3" className="w-full rounded-2xl shadow-lg" />
                            <img src="/api/placeholder/300/400" alt="Gallery 4" className="w-full rounded-2xl shadow-lg" />
                        </div>
                        <div className="space-y-4">
                            <img src="/api/placeholder/300/400" alt="Gallery 5" className="w-full rounded-2xl shadow-lg" />
                            <img src="/api/placeholder/300/300" alt="Gallery 6" className="w-full rounded-2xl shadow-lg" />
                        </div>
                        <div className="space-y-4">
                            <img src="/api/placeholder/300/300" alt="Gallery 7" className="w-full rounded-2xl shadow-lg" />
                            <img src="/api/placeholder/300/400" alt="Gallery 8" className="w-full rounded-2xl shadow-lg" />
                        </div>
                    </div>
                </div>
            </section>
