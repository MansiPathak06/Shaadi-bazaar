  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        >
          <source src="https://assets.mixkit.co/videos/51651/51651-720.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
          <div className="max-w-4xl">
            ...
            <button className="bg-white text-rose-500 px-10 py-4 rounded-full text-lg font-semibold hover:bg-rose-50 transform hover:scale-105 transition duration-300 shadow-2xl">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Watch how we transform dreams into reality
            </p>
          </div>
      ...
      <div className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Everything you need for the perfect engagement
            </p>
          </div>
      ...
      <div className="py-20 px-4 bg-gradient-to-b from-white to-rose-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              A glimpse of our stunning engagement celebrations
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-6">
            {[
              { src: 'https://images.unsplash.com/photo-1519741497674-611481863552?w=800', alt: 'Engagement Ceremony 1' },
              { src: 'https://images.unsplash.com/photo-1606800052052-a08af7148866?w=800', alt: 'Engagement Ceremony 2' },
              { src: 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=800', alt: 'Engagement Ceremony 3' },
              { src: 'https://images.unsplash.com/photo-1464047736614-af63643285bf?w=800', alt: 'Engagement Ceremony 4' },
              { src: 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?w=800', alt: 'Engagement Ceremony 5' },
              { src: 'https://images.unsplash.com/photo-1522673607200-164d1b6ce486?w=800', alt: 'Engagement Ceremony 6' }
            ].map((image, idx) => (
              <div
                key={idx}
      ...
      <div className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Tailored packages to suit every celebration
            </p>
          </div>
              ...
              >
                {pkg.popular && (
                  <div className="text-center mb-4">
                    <span className="bg-white text-rose-500 px-4 py-1 rounded-full text-sm font-bold">
                      Most Popular
                    </span>
                  </div>
                )}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, idx) => (
              ...
              >
                ...
                <p className="font-bold text-rose-500">- {testimonial.name}</p>
              </div>
            ))}
          </div>
        </div>
