    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-3xl md:text-4xl text-rose-400 mb-8 font-semibold">
          ...
          <div className="flex gap-4">
            <button className="bg-rose-400 hover:bg-rose-500 text-white px-10 py-4 rounded-full text-xl font-semibold transition-all transform hover:scale-105 shadow-2xl">
              Explore Destinations
            </button>
            <button className="bg-white/20 backdrop-blur-md hover:bg-white/30 text-white border-2 border-white px-10 py-4 rounded-full text-xl font-semibold transition-all transform hover:scale-105">
              View Packages
            </button>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-rose-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-gray-800 mb-4">Why Choose a Destination Wedding?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Transform your special day into an extraordinary vacation experience
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-gray-800 mb-4">Popular Destinations</h2>
            <p className="text-xl text-gray-600">Discover your perfect wedding location</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {destinations.map((dest, i) => (
              <div 
                ...
                className={`relative overflow-hidden rounded-3xl shadow-2xl hover:shadow-rose-400/30 transition-all duration-500 group bg-white cursor-pointer transform hover:scale-105 ${
                  activeDestination === i ? 'ring-4 ring-rose-400 scale-105' : ''
                }`}
              >
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 bg-gradient-to-r from-rose-400 to-rose-600 text-white px-4 py-2 rounded-full shadow-xl flex items-center gap-2">
                    ...
                    <span className="font-bold text-sm">{dest.badge}</span>
                  </div>
          ...
          <div className="flex gap-3 mt-8 overflow-x-auto pb-4">
            {weddingGallery.map((item, i) => (
              <div
                ...
                className={`relative flex-shrink-0 w-32 h-24 rounded-lg overflow-hidden cursor-pointer transition-all ${
                  currentSlide === i ? 'ring-4 ring-rose-400 scale-110' : 'opacity-60 hover:opacity-100'
                }`}
              >
                {item.type === 'video' ? (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {packages.map((pkg, i) => (
              <div
                ...
                className={`bg-white rounded-2xl shadow-xl overflow-hidden transition-all transform hover:-translate-y-2 cursor-pointer ${
                  selectedPackage === i ? 'ring-4 ring-rose-400 scale-105' : ''
                }`}
              >
