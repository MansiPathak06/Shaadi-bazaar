...
const MensGrooming = () => {
  ...
  const groomingServices = [
    ...
    },
    {
      ...
      image: 'https://i.pinimg.com/736x/20/10/1c/20101c3c1f7da06cae3ce5f19f4f9b30.jpg',
      icon: Sparkles,
      price: 800,
      duration: '45 min',
      popular: false,
    ...
    },
    {
      ...
      image: 'https://i.pinimg.com/1200x/04/ee/b7/04eeb7df2d1aafd5715c726c3da04c20.jpg',
      icon: Zap,
      price: 1500,
      duration: '60-90 min',
      popular: false,
  ...
  const groomPackages = [
    ...
    },
    {
      ...
      image: 'https://i.pinimg.com/736x/a8/c7/b5/a8c7b5ce2cc79cfb5aba549e497c8a1f.jpg',
      features: [
        'Haircut (2 sessions)',
  ...
  return (
    <div className="min-h-screen  bg-white">
      ...
      <div className="py-20  px-30 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">ABOUT US</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-gray-800">
              PREMIUM GROOMING SERVICES
            </h2>
            <p className="text-gray-600 max-w-4xl mx-auto text-lg leading-relaxed mb-12">
              We specialize in groom grooming packages and premium men's services. Our expert barbers and stylists are dedicated to making you look your absolute best for your wedding day and beyond.
            </p>
          </div>
      ...
      <div className="py-20 px-30 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">OUR SERVICES</span>
              ...
              return (
                ...
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    {service.popular && (
                      <div className="absolute top-4 left-4 bg-rose-400 text-white px-3 py-1 rounded-full text-xs font-bold animate-pulse">
                        POPULAR
                      </div>
                    )}
                  </div>
      ...
      <div className="py-20 bg-black text-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">PRICING</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {priceList.map((category, index) => (
              <div
                key={category.id}
                className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-rose-400/50 transition-all duration-300 animate-[slideUp_0.6s_ease-out]"
                style={{ animationDelay: `${index * 0.1}s` }}
              >
                <h3 className="text-2xl font-bold mb-6 text-rose-400 border-b border-white/20 pb-4">
                  {category.category}
                </h3>
                <div className="space-y-4">
                  {category.items.map((item, idx) => (
                    <div key={idx} className="flex justify-between items-center py-3 border-b border-white/10 hover:bg-white/5 transition-colors px-2 rounded">
                      <div>
      ...
      {/* Packages Section */}
      <div className="py-20  px-30 bg-gradient-to-b from-white to-rose-50">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">SPECIAL PACKAGES</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">
              GROOM PACKAGES
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Complete grooming solutions for grooms and groomsmen
            </p>
          </div>
      ...
      <div className="py-20  px-30 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">PREMIUM PARTNERS</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">
              FEATURED SALONS
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Book appointments at our verified grooming partners
            </p>
          </div>
            ...
            {salonVendors.map((salon, index) => (
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <p className="text-rose-400 font-semibold text-sm mb-2">{salon.title}</p>
      ...
      <div className="py-20  px-30 bg-gradient-to-b from-rose-50 to-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <span className="text-rose-400 font-bold tracking-[0.2em] text-sm mb-4 block">TESTIMONIALS</span>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-800">
              HAPPY CLIENTS
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              What our grooms say about their grooming experience
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div className="animate-[slideUp_1s_ease-out]">
              ...
              <div className="text-rose-100">Expert Barbers</div>
            </div>
            <div className="animate-[slideUp_1s_ease-out]">
              <div className="text-5xl font-bold mb-2">15+</div>
              <div className="text-rose-100">Partner Salons</div>
            </div>
            <div className="animate-[slideUp_1s_ease-out]">
