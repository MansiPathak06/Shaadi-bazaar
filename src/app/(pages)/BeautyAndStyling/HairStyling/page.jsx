...
const HairStyling = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            <h2 className="text-4xl md:text-5xl font-serif mb-4">
              FROM CLASSIC CUTS TO CREATIVE COLOR
            </h2>
            <p className="text-gray-600 max-w-3xl mx-auto text-lg">
              Whether you dream of a timeless updo or want to make a bold statement with modern styling, our expert team delivers exceptional results tailored to your wedding vision and personal style.
            </p>
          </div>
              ...
              >
                ...
                <div className="absolute inset-0 p-8 flex flex-col justify-end text-white">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-gray-600">
                    ...
                    <button className="bg-rose-400 hover:bg-rose-500 text-white px-6 py-2 rounded-md font-semibold transition-all duration-300 transform hover:scale-105">
                      Book Now
                    </button>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Complete hair styling solutions for every member of your wedding party
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="animate-[slideLeft_1s_ease-out]">
              ...
              <button className="bg-rose-400 hover:bg-rose-500 text-white px-8 py-3 rounded-md font-semibold transition-all duration-300 inline-flex items-center transform hover:scale-105 hover:shadow-lg">
            ...
            {stylistExperts.map((stylist, index) => (
              ...
              >
                ...
                <div className="p-5 flex-grow flex flex-col">
                  ...
                  <p className="text-rose-400 font-semibold text-sm mb-2">{stylist.title}</p>
      ...
      <div className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center mb-16 animate-[fadeIn_1s_ease-out]">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto text-lg">
              Real brides sharing their beautiful experiences with our hair styling services
            </p>
          </div>
      ...
      {/* Stats Section */}
      <div className="bg-gradient-to-r from-rose-400 to-rose-500 py-16 overflow-hidden">
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div className="animate-[slideUp_1s_ease-out] delay-100">
              <div className="text-5xl font-bold mb-2">50+</div>
              <div className="text-rose-100">Expert Stylists</div>
            </div>
            <div className="animate-[slideUp_1s_ease-out] delay-200">
              <div className="text-5xl font-bold mb-2">15+</div>
              <div className="text-rose-100">Years Experience</div>
            </div>
            <div className="animate-[slideUp_1s_ease-out] delay-300">
