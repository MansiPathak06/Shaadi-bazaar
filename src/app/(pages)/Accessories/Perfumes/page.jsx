        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center pt-16">
          ...
          <div className="space-y-8 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <button className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-8 py-4 rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                SHOP NOW
              </button>
